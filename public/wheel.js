...
var spinDuration = 5000; // value in milliseconds
var gameController;

function Wheel(id, o, gameControllerParam) {
...
Wheel.prototype = {
        ...
        spin: function(){
            var that = this;
            gameController.spinsLeft--;
            gameController.disableSpinButtons();
            this.setDeceleratingTimeout(function(){that.rotate();}, 10, 10000);
        },
            ...
            var internalCallback = function(tick, counter) {
                return function() {
                    ...
                    else
                    {
                        ...
                        self.draw(startAngleBuffer, true);
                    }
                }
            }(times, 0);
	...
	draw: function(startingRotationDegrees, highlight) {
                var self = this;
